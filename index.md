...
- 2023-05-08 Enable publishing preview application images to <ghcr.io> also for pull requests from forks. See [PR#9575](https://github.com/IQSS/dataverse/pull/9575) for details.
